...
for RANGE_FROM in [10100,10200,10300]:
    ...
    navigation.fill_field(driver,"RANGETO",str(RANGE_FROM+99),False)
    navigation.select(driver,"exportformat","UTF16Delimited")

    navigation.wait_and_click(driver,"imgBnOk")
    print("Waiting for file download")
    time.sleep(15) # should wait until download button appears
    # close the window
    driver.close()
